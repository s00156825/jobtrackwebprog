<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="jobtrack.Account.OpenAuthProviders" %>
...
<div id="socialLoginList">
    ...
    <asp:ListView runat="server" ID="providerDetails" ItemType="System.String"
        ...
        <ItemTemplate>
            <p>
<<<<<<< HEAD
                <button type="submit" id="<%#: Item %>-login-button" class="btn btn-default" name="provider" value="<%#: Item %>"
=======
